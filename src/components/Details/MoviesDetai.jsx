...
const MovieDetail = ({movieSinglePage,setNameFromTrailer,setOpenBackdrop,movieNameTriler}) => {
                    ...
                    <Grid2 container >
                        ...
                        <Grid2 xs={12} sm={12} md={8} lg={8} xl={8} sx={{ direction: 'rtl', padding: '0 1rem' }}>
                            ...
                            <h5 className='h5-single'>
                                ...
                                {`تاریخ انتشار :${movieSinglePage?.release_date}`}
                            </h5>
